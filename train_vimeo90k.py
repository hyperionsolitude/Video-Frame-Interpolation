...
def train(args, ddp_model):
    ...
    dataset_train = Vimeo90K_Train_Dataset(dataset_dir='./Datasets/Vimeo90K/vimeo_triplet', augment=True)
    ...
    dataset_val = Vimeo90K_Test_Dataset(dataset_dir='./Datasets/Vimeo90K/vimeo_triplet')
